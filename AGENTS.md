...
Orbit data can be accessed remotely via web API, locally via `http://localhost:4321`, or directly via local Markdown files/CLI.
...
- **Create Project**: `POST https://orbit.nvkhuy.com/api/projects` (`{"title": "...", "color": "#e3f2fd", "content": "..."}`)
...
- **Rule**: Backgrounds MUST use soft pastel hues to blend with pencil-black borders (`#2d2d2d`) and maintain card readability.
